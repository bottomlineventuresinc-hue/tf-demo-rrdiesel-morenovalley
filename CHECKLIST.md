# Site customization checklist · RR Diesel Electric (hs-043-rrdiesel)
Wave 9 · Copperline · claim/$297 + hosting/$99 bar required. Rebuilt 2026-09-25 (CEO change request).

Before preview send:
- [x] Business name everywhere (title, wordmark, footer, schema)
- [x] City / service area
- [x] Phone click-to-call is the main CTA (tel-only; no public email)
- [x] Address per packet (FARM-PACKETS-WAVE9.md)
...
Owner first name in human spots: Richard
NAP/phone per packet: 27315 Cedar Court, Moreno Valley CA 92553 · 562-244-2018
lang: en-US · geo: CA
...
Lead-specific notes kept: rrdiesel.com is an unrelated diesel repair shop; NOT linked or offered. Phone 562 area code per packet.
Prior folder backed up at ops/cr-2026-09-25/backup/hs-043-rrdiesel/.
