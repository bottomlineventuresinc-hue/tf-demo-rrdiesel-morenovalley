/* Template Factory - RR Diesel Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-rrdiesel-morenovalley/';
  var LS_CHANGES = 'tf_rrdiesel_change_log_v1';
  var LS_PURCHASED = 'tf_rrdiesel_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential and commercial electrical, panel work, and wiring across Moreno Valley and the Inland Empire. You get a fixed itemised quote before we start, Richard as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Richard at RR Diesel Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Richard at RR Diesel Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for RR Diesel Electric. Hang tight.',
        delay,
        function () {
